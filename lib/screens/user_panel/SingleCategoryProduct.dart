...
class AllSingleCategoryProductsScreen extends StatefulWidget {
  String categoryName;
  AllSingleCategoryProductsScreen({super.key,required this.categoryName});
...
class _AllSingleCategoryProductsScreenState extends State<AllSingleCategoryProductsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: FirebaseFirestore.instance.collection('products').where("categoryName",isEqualTo:widget.categoryName).get(),
